...
// templating-engine dependency, per the plan's "server-rendered views
// (EJS or plain HTML), minimal JS."
...
const STYLE = `
  ...
  * { box-sizing: border-box; }
  ...
  header { background:linear-gradient(180deg,#23324a,#2b4c7e); color:#fff; padding:20px 28px; }
  ...
  nav a { color:#dbe6f5; text-decoration:none; }
...
<title>${escapeHtml(title)} -- Common Credo Issuer Tool</title>
<style>${STYLE}</style></head>
<body>
<header>
  <a href="/">Common Credo -- Issuer Tool</a>
  ${nav !== false ? `<nav>
    <a href="/dashboard">Dashboard</a>
    <a href="/records">Records</a>
    <a href="/records/new">New Record</a>
    <a href="/cancellations">Cancellations</a>
    <a href="/holder-requests">Holder Requests</a>
  </nav>` : ''}
</header>
<main>${body}</main>
</body></html>`;
